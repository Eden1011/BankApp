Feature: Account registry
  ...
  Scenario: User is able to create a second account
    ...
    When I create an account using name: "dave", last name: "grohl", pesel: "90010112345"
  ...
  Scenario: User is able to update surname of already created account
    Given Account with pesel "90010112345" exists in registry
    When I update "nazwisko" of account with pesel: "90010112345" to "grohlsen"
    Then Account with pesel "90010112345" has "nazwisko" equal to "grohlsen"
  ...
  Scenario: User is able to delete last account
    Given Account with pesel "90010112345" exists in registry
    When I delete account with pesel: "90010112345"
    Then Account with pesel "90010112345" does not exist in registry
